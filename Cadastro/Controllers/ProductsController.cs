...
namespace Cadastro.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProduto,Name,Value,Available")] ProductViewModel productViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduto,Name,Value,Available")] ProductViewModel productViewModel)
        {
            if (id != productViewModel.IdProduto)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProductViewModelExists(productViewModel.IdProduto))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.ProductViewModel.Any(e => e.IdProduto == id);
        }
    }
}
